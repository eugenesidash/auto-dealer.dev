<div class="bg-3">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6">
				<div class="ocenka-video">
					<p>Видео процесса выкупа</p>
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-lg-12 vikup-avto-normal">
				<div id="content-avto">
					<div id="screen-avto">
						...
						<div class="last-vikup">
							...
							<div class="last-vikup-name">
								<h3>Mercedes-Benz<br>GLS 63 AMG (X166)</h3>
							</div>
							<div class="last-vikup-price">
				...
				<button id="prev-avto">&lt;</button>
				<button id="next-avto">&gt;</button>
			</div>
			<div class="col-lg-12 vikup-avto-media">
				<div id="content-avto-media">
					<div id="screen-avto-media">
						<div class="last-vikup">
							<div class="last-vikup-info">
								<img src="<?php bloginfo('template_directory') ?>/img/car-1.png" alt="car">
								<p>Год: <span>2007</span></p>
				...
				<button id="prev-avto-media">&lt;</button>
				<button id="next-avto-media">&gt;</button>
			</div>
			<div class="col-lg-12 vikup-avto-media-800">
				<div id="content-avto-media-800">
					<div id="screen-avto-media-800">
						<div class="last-vikup">
							<div class="last-vikup-info">
								<img src="<?php bloginfo('template_directory') ?>/img/car-1.png" alt="car">
								<p>Год: <span>2007</span></p>
				...
				<button id="prev-avto-media-800">&lt;</button>
				<button id="next-avto-media-800">&gt;</button>
			</div>
		</div>
	</div>
</div>